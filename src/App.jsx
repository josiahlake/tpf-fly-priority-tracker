...
function injectPrintStyles() {
  ...
  style.textContent = [
    ...
    "  .task-card { border: 1px solid #ccc !important; background: white !important; break-inside: avoid; }",
    "  .quadrant-panel { border: 1px solid #333 !important; background: white !important; break-inside: avoid; }",
    "}"
  ].join("\n");
    ...
    <div className="task-card" style={{background:"#fff",border:"1.5px solid "+quadrant.border,borderRadius:"10px",padding:"10px 12px",marginBottom:"7px",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",position:"relative"}} onMouseEnter={e=>e.currentTarget.style.boxShadow="0 3px 10px rgba(0,0,0,0.10)"} onMouseLeave={e=>e.currentTarget.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)"}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"5px"}}>
        ...
        <div className="no-print" style={{display:"flex",gap:"2px"}}>
          <button onClick={()=>setExpanded(v=>!v)} style={{background:"none",border:"none",cursor:"pointer",fontSize:"12px",opacity:0.4,padding:"1px 3px"}} title="Expand for notes">{expanded?"▲":"▼"}</button>
...
function QuadrantPanel({ quadrant, tasks, onAdd, onUpdate, onDelete, onMove }) {
  ...
  return (
    <div className="quadrant-panel" style={{background:quadrant.bg,border:"2px solid "+quadrant.border,borderRadius:"14px",padding:"14px",display:"flex",flexDirection:"column",minHeight:"280px"}}>
        ...
        <div style={{marginBottom:"16px"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:"12px"}}>
            <div>
              ...
              <p style={{margin:"2px 0 0",fontSize:"12px",color:"#94a3b8"}}>Not Started &amp; In Progress tasks auto-carry each week.</p>
            </div>
            <div style={{display:"flex",gap:"8px",flexWrap:"wrap",alignItems:"center"}}>
              ...
              <div className="no-print" style={{display:"flex",flexDirection:"column",gap:"5px"}}>
                ...
                <div style={{display:"flex",gap:"4px"}}>
                  ...
                  <button onClick={()=>window.print()} style={{background:"#475569",color:"#fff",border:"none",borderRadius:"8px",padding:"7px 10px",fontSize:"12px",cursor:"pointer",fontWeight:700}} title="Print clean B&W version">🖨️</button>
                </div>
              </div>
            </div>
          </div>
